...
//                    }
                ...
                function inputEvent(e) {
                    ...
                    if (pasted) {
                        if (!isValidString(val)) $input.val(lastVal);
                    } else if (!removed) {
                        if (!isValidChar(inserted)) $input.val(lastVal);
                    }
                    startPos = $input.val().length;
...
//                    $input.bind("textInput.maskMoney", textInputEvent);
                } else {
                ...
                $input.bind("cut.maskMoremovedney", cutPasteEvent);
